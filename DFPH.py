...
# def adsh_algo(code_length, tt):
    ...
    # lri = {0: 0.0011, 1: 0.001, 2: 0.0009, 3: 0.0008, 4:0.0007,5:0.0006}
    # learning_ratei = lri[index]
    # lrt = {0: 0.0022, 1: 0.002, 2: 0.0018, 3: 0.0016, 4:0.0014,5:0.0012}
    # learning_ratet = lrt[index]
    lri = {16: 0.0008, 32: 0.0006, 48: 0.0005, 64: 0.0003}
    learning_ratei = lri[code_length]
    # learning_ratei = 0.001
    lrt = {16: 0.002, 32: 0.0017, 48: 0.001, 64: 0.001}
    learning_ratet = lrt[code_length]
    # learning_ratet = 0.02#10 ** (-1.5)
